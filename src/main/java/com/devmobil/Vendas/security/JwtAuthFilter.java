...
public class JwtAuthFilter extends OncePerRequestFilter{
    ...
    public JwtAuthFilter( JwtService jwtService, UserService service ) {
    ...
    protected void doFilterInternal(
        ...
        if( authorization != null && authorization.startsWith("Bearer")){
            ...
            if(isValid){
                String loginUsuario = jwtService.getUserAuth(token);
                UserDetails usuario = service.loadUserByUsername(loginUsuario);
